...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [Widget_key]: null,
        [SingleChildRenderObjectWidget_child]: C[2] || CT.C2,
        [Align_heightFactor]: null,
        [Align_widthFactor]: null,
        [Align_alignment]: C[3] || CT.C3
      });
    },
    get C6() {
    ...
    get C5() {
      return C[5] = dart.const({
        ...
        [CircularProgressIndicator__indicatorType]: C[6] || CT.C6
      });
    },
    get C4() {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Фотогалерея", home: new main.MyHomePage.new({title: "Фотогалерея"})});
    }
  };
  ...
  var title$0 = dart.privateName(main, "MyHomePage.title");
  ...
  main.MyHomePage = class MyHomePage extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.title), backgroundColor: colors.Colors.green}), body: new (T.FutureBuilderOfListOfPhoto()).new({future: main.fetchPhotos(client$.Client.new()), builder: dart.fn((context, snapshot) => {
  ...
  main.PhotosList = class PhotosList extends framework.StatelessWidget {
    ...
    build(context) {
      return new scroll_view.GridView.builder({gridDelegate: C[7] || CT.C7, itemCount: this.photos[$length], itemBuilder: dart.fn((context, index) => new image.Image.network(this.photos[$_get](index).thumbnailUrl), T.BuildContextAndintToImage())});
    }
  };
  ...
  main.fetchPhotos = function fetchPhotos(client) {
    return async.async(T.ListOfPhoto(), function* fetchPhotos() {
      let response = (yield client.get(core.Uri.parse("https://github.com/OmicronSir/Taranenko-V/blob/json/photos.json")));
      if (response.statusCode === 200) {
        let photosJson = core.List.as(convert.jsonDecode(response.body));
        return photosJson[$map](main.Photo, dart.fn(json => main.Photo.fromJson(T.MapOfString$dynamic().as(json)), T.dynamicToPhoto()))[$toList]();
      } else {
        dart.throw(core.Exception.new("Failed to load photos"));
      }
    });
  };
  main.main = function main$0() {
    return binding.runApp(C[8] || CT.C8);
  };
